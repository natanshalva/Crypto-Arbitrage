...
for (var i = 0; i < orders_to_inspect.length; i++) {
  ...
  //    Bi2c
  //------------------------------------------------------------
  function execute_bi2c_sort(bit2c_co_il_BTC_NIS,
                             bit2c_co_il_BTG_NIS_order_book, coin, action_i) {
    ...
    function normalize_Bi2c(coin_value, coin_fee, reference_point_BTC_v_r_i_NIS,
                            BTC_fee) {
    ...
    bi2c_sorted_in_function.u_can_buy_BTG_in_BI2C_for_BTC = normalize_Bi2c(
        bi2c_sorted_in_function.lowest_price_to_sell_BTG__in_bi2c, 1.005,
    ...
    bi2c_sorted_in_function.u_can_sell_BTG__in_bi2c_for_BTC = normalize_Bi2c(
        bi2c_sorted_in_function.haighest_price_to_buy_BTG___in_bi2c, 0.995, // 0.5%
        reference_point_BTC_v_r_i_NIS, 0.995 // 0.5%

    );
    //  console.log( 'u_can_sell_BTG__in_bi2c_for_BTC ',bi2c_sorted.u_can_sell_BTG__in_bi2c_for_BTC ) ;

    DEBUG && console.log('bi2c_sorted_in_function'.info, bi2c_sorted_in_function);
  ...
  DEBUG &&
  console.log('u_can_sell_BTG_in_Bit_z_com'.info, u_can_sell_BTG_in_Bit_z_com);
