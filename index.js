...
function run_in_loop () {           //  create a loop function
...
// start check with
          ...
          function quantity_available_for_trade(quantity_for_sell,
                                                quantity_available) {
            DEBUG &&
            console.log('we are in: quantity_available_for_trade'.info);
            DEBUG && console.log('quantity_for_sell: '.info, quantity_for_sell);
            DEBUG &&
            console.log('quantity_available: '.info, quantity_available);
          ...
          function price_in_BTC_dobel_quantity_in_BTG_of_this_price(margin,
            ...
            DEBUG && console.log('      ');
            DEBUG && console.log(
                'we are in price_in_BTC_dobel_quantity_in_BTG_of_this_price');
            DEBUG && console.log('margin'.info, margin);
            ...
            DEBUG &&
            console.log('price_in_BTC_dobel_quantity_in_BTG_of_this_price'.info,
                re);
            return re;
          }
          ...
          function print_BTC_in_NIS(value, buy_bitcoin_in_NIS, text) {
            ...
            DEBUG &&
            console.log('buy_bitcoin_in_NIS: '.info, buy_bitcoin_in_NIS);
          ...
          for (var i = 0; i < 1; i++) {
            ...
            DEBUG && console.log('bit2c_co_il_BTG_NIS_order_book.asks : '.info,
                orders_to_inspect[i]);
            ...
            if (buy__BTG__in_Bit_z_com__sell_in_Bi2c_price_margin > 0) {
              ...
              console.log(
                  'ok, this is minus margin - we are out of this loop  ');
              DEBUG && console.log(' ');
  ...
  setTimeout(run_in_loop, delay_in_milliseconds );
  };
