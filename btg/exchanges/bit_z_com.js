...
/*  function normalize_Bit_z_com(coin_value, coin_fee, bit2c_co_il_NIS_BTC) {
 ...
 // bit_z_com_sorted.u_can_sell_in_Bit_z_com = (bit_z_com_depth.data.bids[action_i][0] * 0.999) * 0.995;
  ...
  bit_z_com_sorted.u_can_sell_in_Bit_z_com = normalize_Bit_z_com(
      ...
      // DEBUG && console.log('u_can_sell_in_Bit_z_com'.info, bit_z_com_sorted);
 // DEBUG && console.log('bit_z_com_depth.data.asks',bit_z_com_depth.data.asks);

  //var sss = bit_z_com_depth.data.asks ;
 //  var gg = sss.reverse();
//   DEBUG && console.log('asks after sort',gg);
 // DEBUG && console.log('bit_z_com_depth.data.asks[action_i][0]', bit_z_com_depth.data.asks[action_i][0]);
