...
module.exports = function (Big,colour) {
  return  function normalize_Bit_z_com(coin_value, trade_fee, withdraw_fee){
    ...
    DEBUG &&
    console.log('after_withdraw_fee: '.info, parseFloat(after_withdraw_fee));

    var re = parseFloat(after_withdraw_fee);

    DEBUG &&
    console.log('(calculte the coin * fee ) * withdraw_fee : '.info, re);
    return re;
  };
};